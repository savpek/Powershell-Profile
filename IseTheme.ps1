...
$psISE.Options.XmlTokenColors['Comment'] = '#FF6E715E'
$psISE.Options.XmlTokenColors['CommentDelimiter'] = '#FF6E715E'
$psISE.Options.XmlTokenColors['ElementName'] = '#FFF92659'
$psISE.Options.XmlTokenColors['MarkupExtension'] = '#FFA6E22E'
$psISE.Options.XmlTokenColors['Attribute'] = '#FF9CD8F0'
$psISE.Options.XmlTokenColors['Text'] = '#FFFFFFFF'
$psISE.Options.XmlTokenColors['CharacterData'] = '#FFFFFFFF'
$psISE.Options.XmlTokenColors['Tag'] = '#FFF92659'
$psISE.Options.XmlTokenColors['QuotedString'] = '#FFFFFFFF'
$psISE.Options.XmlTokenColors['Quote'] = '#FF9CD8F0'